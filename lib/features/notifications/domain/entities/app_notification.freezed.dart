...
class _$AppNotificationImpl extends _AppNotification {
  ...
  @override
  String toString() {
    return 'AppNotification(id: $id, type: $type, title: $title, body: $body, imageUrl: $imageUrl, pageName: $pageName, pageId: $pageId, actionUrl: $actionUrl, isRead: $isRead, createdAt: $createdAt)';
  }
